...
export default function App() {
  ...
  const [gameId, setGameId] = useState<string | null>(validJoinLink?.gameId ?? restored?.gameId ?? null);
  ...
  return (
    <div style={S.app}>
      <div style={S.wrap}>
        ...
        {mode === "multi" && gameId && <MultiplayerGame gameId={gameId} initialJoinCode={validJoinLink?.code} />}
      </div>
