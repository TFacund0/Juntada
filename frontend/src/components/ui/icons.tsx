...
/** Escanear código QR — botón "Escanear código QR" de GroupEntryCard/RoomEntryCard. */
export function QrIcon({ size = 16, color = "currentColor", strokeWidth = 2 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Ícono de sonido activo — parlante emitiendo ondas (Feather-style). */
export function SoundOnIcon({ size = 16, color = "currentColor", strokeWidth = 2 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Ícono de sonido silenciado — parlante tachado con cruz (Feather-style). */
export function SoundOffIcon({ size = 16, color = "currentColor", strokeWidth = 2 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
