...
export function LocalGame() {
    ...
    return (
      ...
      <div>
        <div style={{ ...S.cardHighlight, textAlign: "center" }}>
          <p style={{ fontSize: 13, color: "#9089c0" }}>Turno {turnNumber}/{totalTurns}</p>
  ...
  return (
    <PhaseTransition phaseKey="result">
      ...
      <ConfirmBackButton title="¿Volver a nombres?" message="Se pierde el marcador de esta partida." confirmLabel="Volver" onConfirm={backToSetup}>
        Volver a nombres
      </ConfirmBackButton>
    </PhaseTransition>
  );
