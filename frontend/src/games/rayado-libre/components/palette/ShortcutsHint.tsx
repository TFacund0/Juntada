...
/** Línea con los atajos de teclado, debajo de la paleta. Solo en compu, y no con la segunda fila partida (ver Palette). */
export function ShortcutsHint() {
  return (
    <div className="hidden text-center text-[11px] text-rl-muted @min-[1000px]/stage:@min-[372px]/palette:block landscape-short:hidden">
