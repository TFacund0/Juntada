...
const PIP_LAYOUTS = {
  1: [[50, 70]],
  2: [[50, 42], [50, 98]],
  3: [[50, 35], [50, 70], [50, 105]],
  4: [[32, 42], [68, 42], [32, 98], [68, 98]],
  5: [[32, 38], [68, 38], [50, 70], [32, 102], [68, 102]],
  6: [[32, 35], [68, 35], [32, 70], [68, 70], [32, 105], [68, 105]],
  7: [[32, 32], [68, 32], [32, 58], [68, 58], [50, 74], [32, 108], [68, 108]],
};
...
function CardFace({ card }) {
  ...
  const Corner = ({ rotate }) => (
    <g transform={rotate ? "rotate(180 50 70)" : undefined}>
      <text x={9} y={17} fontSize={11} fontWeight={800} fill={suit.color} fontFamily="inherit">{label}</text>
    </g>
  );
...
function CardBack() {
  return (
    <svg viewBox="0 0 100 140" style={{ display: "block", width: "100%", height: "100%" }}>
      ...
      <text x={50} y={80} textAnchor="middle" fontSize={34}>🍋</text>
    </svg>
  );
}

// Carta grande (revelada) o el lomo del mazo (dorso) si no se pasa `card`.
export function CardView({ card, size = "large", onClick }) {
