...
export const codenamesGame = {
  id: "codenames",
  label: "Codenames",
  icon: "🗝️",
  description: "Por equipos: el spymaster da una pista (palabra + número) para que su equipo adivine las palabras del tablero sin caer en la del rival ni en la asesina.",
  minPlayers: 4,
  comingSoon: true,
  rules: [
